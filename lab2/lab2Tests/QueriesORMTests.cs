...
namespace lab2Tests
{
    public class QueriesORMTests
    {
        QueriesORM queriesORM;
        public QueriesORMTests()
        {
            ...
            queriesORM = new QueriesORM();
        }

        [Fact]
        public void GetSumWeightTest()
        {
            var result = queriesORM.GetSumWeight();
        ...
        {
            List<Customer> result = queriesORM.GetCustomersFromBrest();
        ...
        public void GetAllCustomersTest()
        {
            ...
            var result = queriesORM.GetAllCustomers();
        ...
        {
            var result = queriesORM.AddColumns();
        ...
        {
            var result = queriesORM.AddShopTable();
            Assert.Equal(7, result);
        }
        ...
        {
            var result = queriesORM.CountCustomersByHeight();
        ...
        {
            var result = queriesORM.GetMinMaxWeights();
        ...
        public void GetCustomersAndShopsByIDTest()
        {
            ...
            var result = queriesORM.GetCustomersAndShopsByID();
